<div>
    <x-ui.content.block-head :title="__('Editer une Direction')">
        <x-ui.block.button.link
            icon="arrow-long-left"
            :route="route('entity.lists-direction')"
            :action="__('Retour')"
        />
            ...
            <x-ui.forms.layout wire:submit.prevent="submit">
                <div class="row g-gs px-4 py-2">
                    ...
                    <div class="col-lg-12 col-sm-12">
                        <div class="form-group">
                            <x-ui.forms.input.label for="designation">Description de la direction
