<div>
    <x-contents.brandcrumb
            ...
            action="Ajouter un Grades"
            :route="route('add-grade')"
    />
            ...
            <table class="datatable-init nk-tb-list nk-tb-ulist"
                ...
                <tr class="nk-tb-item nk-tb-head">
                    ...
                    <th class="nk-tb-col  tb-col-mb">
                        <span class="sub-text">Niveau de Grade</span>
                    </th>
                    <th class="nk-tb-col tb-col-mb">
                        <span class="sub-text">Sigle</span>
                    </th>
                    <th class="nk-tb-col tb-col-md">
                        <span class="sub-text">Echelon</span>
                    </th>
                                    ...
                                    <div class="drodown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end">
                                            <ul class="link-list-opt no-bdr">
                                                <li>
                                                    <a
                                                            href="{{ route('edit-grade', $grade->id) }}">
