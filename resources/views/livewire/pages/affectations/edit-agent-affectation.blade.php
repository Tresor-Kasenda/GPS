<div>
    <x-ui.content.block-head
        ...
        :description="'Nom: '. $affectation->agent->person->name .' ||  Post-Nom: '. $affectation->agent->person->username .  ' || Prenom: '. $affectation->agent->person->firstname"
    >
                            ...
                            <select
                                ...
                                @foreach($functions as $function)
                                    <option
                                        ...
                                        value="{{ $function->id }}"
                                        {{ $affectation->company_function_id == $function->id ? 'selected' : '' }}
                                    >
