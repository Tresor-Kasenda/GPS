<form class="nk-stepper stepper-init is-alter nk-stepper-s1" id="stepper-create-project">
                ...
                <div class="nk-stepper-content">
                    <div class="nk-stepper-steps stepper-steps">
                            ...
                            <div class="row g-3">
                                <div class="col-12">
                                    <div class="form-group">
                                        <label class="form-label" for="cp1-project-name">Project Name</label>
                                        <div class="form-control-wrap">
                                            <input type="text" class="form-control" id="cp1-project-name"
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        <label class="form-label" for="cp1-project-description">Project
                                            Description</label>
                                        <div class="form-control-wrap">
                                            <textarea class="form-control form-control-sm" id="cp1-project-description"
                                                      name="cp1-project-description"
                                                ...
                                                <li>
                                                    <div class="custom-control custom-radio">
                                                        <input type="radio" class="custom-control-input"
                                                               ...
                                                               value="public_project" required>
                                                        <label class="custom-control-label" for="cp1-public-project">Public
                                                            Project</label>
                                                    </div>
                                                </li>
                                                <li>
                                                    <div class="custom-control custom-radio">
                                                        <input type="radio" class="custom-control-input"
                                                               ...
                                                               value="private_project" required>
                                                        <label class="custom-control-label" for="cp1-private-project">Private
                                                            Project</label>
                                                    </div>
                                                </li>
                                            </ul>
                            ...
                            <ul class="row g-3">
                                <li class="col-6">
                                    <div
                                        ...
                                        <input type="radio" class="custom-control-input" name="cp1-project-template"
                                               id="cp1-template-scrum" value="cp1-template-scrum" required>
                                        <label class="custom-control-label" for="cp1-template-scrum">
                                            <span
                                                class="d-flex flex-column text-center px-sm-3">
                                                <span
                                                    class="icon-wrap text-info">
                                ...
                                <li class="col-6">
                                    <div
                                        class="custom-control custom-control-sm custom-radio pro-control custom-control-full">
                                        <input type="radio" class="custom-control-input" name="cp1-project-template"
                                               id="cp1-template-kanban" value="cp1-template-kanban" required>
                                        <label class="custom-control-label" for="cp1-template-kanban">
                                                                                        <span
                                                                                            class="d-flex flex-column text-center px-sm-3">
                                                                                            <span
                                                                                                class="icon-wrap text-danger">
                                                                                                <svg viewBox="0 0 44 36"
                                                                                                     xmlns="http://www.w3.org/2000/svg">
                                                                                                    <path
                                                                                            ...
                                                                                            <span class="sub-text">Keep a constant workflow on independent tasks.</span>
                                                                                        </span>
                                        </label>
                                    </div>
                                </li>
                                <li class="col-6">
                                    <div
                                        class="custom-control custom-control-sm custom-radio pro-control custom-control-full">
                                        <input type="radio" class="custom-control-input" name="cp1-project-template"
                                               id="cp1-template-duplicate" value="cp1-template-duplicate" required>
                                        <label class="custom-control-label" for="cp1-template-duplicate">
                                                                                        <span
                                                                                            class="d-flex flex-column text-center px-sm-3">
                                                                                            <span
                                                                                            ...
                                                                                            <span
                                                                                                class="lead-text mb-1 mt-3">Duplicate Project</span>
                                                                                            <span class="sub-text">Start clean and keep your configuration.</span>
                                                                                        </span>
                                        </label>
                                    </div>
                                </li>
                                <li class="col-6">
                                    <div
                                        class="custom-control custom-control-sm custom-radio pro-control custom-control-full">
                                        <input type="radio" class="custom-control-input" name="cp1-project-template"
                                               id="cp1-template-import" value="cp1-template-import" required>
                                        <label class="custom-control-label" for="cp1-template-import">
                                                                                        <span
                                                                                            class="d-flex flex-column text-center px-sm-3">
                                                                                            <span
                                                                                            ...
                                                                                            <span
                                                                                                class="lead-text mb-1 mt-3">Import Project</span>
                                                                                            <span class="sub-text">Prioritize and solve your tasks in short time cycles.</span>
                                                                                        </span>
                                        </label>
                                    </div>
                            ...
                            <ul class="row g-3">
                                <li class="col-6">
                                    <div
                                        ...
                                        <input type="checkbox" class="custom-control-input" name="cp1-project-team"
                                               id="cp1-team-1" value="cp1-team-1" required>
                                ...
                                <li class="col-6">
                                    <div
                                        class="custom-control custom-control-sm custom-control-pro custom-checkbox custom-control-full">
                                        <input type="checkbox" class="custom-control-input" name="cp1-project-team"
                                               id="cp1-team-2" value="cp1-team-2" required>
                                ...
                                <li class="col-6">
                                    <div
                                        class="custom-control custom-control-sm custom-control-pro custom-checkbox custom-control-full">
                                        <input type="checkbox" class="custom-control-input" name="cp1-project-team"
                                               id="cp1-team-3" value="cp1-team-3" required>
                                        <label class="custom-control-label" for="cp1-team-3">
                                                                                        <span class="user-card">
                                                                                            <span
                                                                                                class="user-avatar sq bg-purple">
                                                                                                <span>DM</span>
                                                                                            </span>
                                                                                            <span class="user-info">
                                ...
                                <li class="col-6">
                                    <div
                                        class="custom-control custom-control-sm custom-control-pro custom-checkbox custom-control-full">
                                        <input type="checkbox" class="custom-control-input" name="cp1-project-team"
                                               id="cp1-team-4" value="cp1-team-4" required>
                                ...
                                <li class="col-6">
                                    <div
                                        class="custom-control custom-control-sm custom-control-pro custom-checkbox custom-control-full">
                                        <input type="checkbox" class="custom-control-input" name="cp1-project-team"
                                               id="cp1-team-5" value="cp1-team-5" required>
                                ...
                                <li class="col-6">
                                    <div
                                        class="custom-control custom-control-sm custom-control-pro custom-checkbox custom-control-full">
                                        <input type="checkbox" class="custom-control-input" name="cp1-project-team"
                                               id="cp1-team-6" value="cp1-team-6" required>
                                        <label class="custom-control-label" for="cp1-team-6">
                                                                                        <span class="user-card">
                                                                                            <span
                                                                                                class="user-avatar sq bg-warning">
                                                                                                <span>JR</span>
                                                                                            </span>
                                                                                            <span class="user-info">
                            ...
                            <div class="row g-3">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <div class="form-control-wrap">
                                            <input type="text" class="form-control" id="cp1-project-client"
                                                   name="cp1-project-client" placeholder="Client or Company name"
                                                   required>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <div class="form-control-wrap">
                                            <select class="form-select js-select2" id="cp1-project-lead"
                                                    name="cp1-project-lead" data-placeholder="Select Lead" required>
                                                <option value=""></option>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-control-wrap">
                                            <input type="text" class="form-control date-picker"
                                                   id="cp1-project-deadline" name="cp1-project-deadline"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-control-wrap">
                                            <input type="text" placeholder="Add Tags"
                                                   class="form-control js-tagify tagify" id="cp1-project-tags"
                                                ...
                                                <li>
                                                    <div class="custom-control custom-control-sm custom-checkbox">
                                                        <input type="checkbox" class="custom-control-input"
                                                               name="cp1-follow-project" id="cp1-follow-project"
                                                               value="follow_project">
                                                        <label class="custom-control-label" for="cp1-follow-project">Follow
                                                            Project</label>
                                                    </div>
                                                </li>
                                                <li>
                                                    <div class="custom-control custom-control-sm custom-checkbox">
                                                        <input type="checkbox" class="custom-control-input"
                                                               name="cp1-save-project" id="cp1-save-project"
                                                               value="save_project">
                                                        <label class="custom-control-label" for="cp1-save-project">Save
                                                            Project</label>
                                                    </div>
                                                </li>
                                            </ul>
                        ...
                        <div class="nk-stepper-step text-center">
                            ...
                            <p class="text-soft">Successfully created your project to kickstart now </p>
